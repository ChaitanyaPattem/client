...
import { RoundImage5, PhotoImage1 } from "./comp.components";
  ...
  return (
    <Form onSubmit={(e) => submitHandler(e)}>
      <FormGroup className="mb-2 mt-1 d-flex align-items-center position-relative">
        <RoundImage5 className="mr-2" src={user.profile_photo} />
        <Input
          value={content}
          ...
          type="textarea"
        />
        <PhotoImage1 size={24} fill="green" onClick={() => setImageForm(!imageForm)}/>
      </FormGroup>
      <CSSTransition
          in={imageForm}
          timeout={300}
