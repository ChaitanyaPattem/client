...
import { Comments, CommentsForm, Likes } from "../Components";
import {
  AiFillLike,
  AiOutlineLike,
  AiFillDelete,
  ...
  return (
    <PostContainer className="mb-2">
      <Header1 className="mb-2">
        ...
        >
          <RoundImage3 src={post.user.profile_photo} />
        </Link>
        <FlexContainer>
          <div>
            <h4 className="mb-0">
      ...
      <Footer>
        <TopFooter>
          <ClickDiv onClick={() => setLikesModal(true)} className="d-flex">
            <RoundWrapper1 className="mr-1" bgColor="royalblue">
              <AiFillLike
                data-toggle="tooltip"
                data-html="true"
                title={<em></em>}
      ...
      <CSSTransition
        ...
        unmountOnExit
      >
        <Likes setLikesModal={setLikesModal} likes={post.likes} />
      </CSSTransition>
    </PostContainer>
  );
};
