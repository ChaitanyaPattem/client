...
import { PhotosScreen } from "../screens";
  ...
  return (
    currentUser && (
      <Container fluid className="p-0">
        ...
        {subPage === "main" && (
          <Main>
            <Col className="pt-3 d-none d-lg-block" sm="5">
              ...
              <PhotosScreen user={currentUser} photos={photos} />
            </Col>
            <Col className="pt-3">
              {currentUser._id === user._id && (
                <PostsForm posts={posts} setPosts={setPosts} user={user} />
              )}
              {currentUser !== user && (
        ...
        {subPage === "photos" && <PhotosScreen user={currentUser} photos={photos} />}
        {subPage === "friends" && (
